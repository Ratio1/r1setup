...
```bash
curl -sL https://raw.githubusercontent.com/Ratio1/r1setup/refs/heads/main/mnl_factory/scripts/install-factory.sh -o install-factory.sh && bash install-factory.sh
```
